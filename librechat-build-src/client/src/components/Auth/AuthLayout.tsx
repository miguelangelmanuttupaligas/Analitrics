  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-white dark:bg-gray-900">
      ...
      <BlinkAnimation active={isFetching}>
        <div className="mt-6 flex w-full items-center justify-center bg-cover">
          <div className="flex items-center justify-center gap-3 dark:hidden">
            <img
              src="assets/logo-app.png"
              className="h-10 w-10 object-contain"
              alt={localize('com_ui_logo', { 0: startupConfig?.appTitle ?? 'Analitrics' })}
            />
            <span className="text-3xl font-semibold tracking-tight text-violet-700">
              {startupConfig?.appTitle ?? 'Analitrics'}
            </span>
          </div>
          <img
