...
/* Analitrics */
export const getAnalitricsContext = <T = unknown>(conversationId: string): Promise<T> => {
  return request.get(endpoints.analitricsContext(conversationId));
};

export const saveAnalitricsCatalogFeedback = <T = unknown>(payload: {
  conversationId: string;
