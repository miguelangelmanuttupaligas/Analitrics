...
import AnalitricsContextPanel from '~/components/Analitrics/AnalitricsContextPanel';
...
function ChatView({ index = 0, project }: { index?: number; project?: TChatProject }) {
  ...
  const showAnalitricsPanel = Boolean(conversationId && conversationId !== Constants.NEW_CONVO);
      ...
      <ChatContext.Provider value={chatHelpers}>
        <AddedChatContext.Provider value={addedChatHelpers}>
          <Presentation
            analitricsPanel={
              showAnalitricsPanel ? (
                <AnalitricsContextPanel conversationId={conversationId} />
              ) : undefined
            }
          >
